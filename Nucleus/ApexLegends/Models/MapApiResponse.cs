...
public record GameModeRotation(
    [property: JsonPropertyName("current")] MapRotationInfo Current,
...
public record MapRotationInfo(
    ...
    [property: JsonPropertyName("readableDate_start")] string ReadableDateStart,
    [property: JsonPropertyName("readableDate_end")] string ReadableDateEnd,
    [property: JsonPropertyName("map")] string Map,
    [property: JsonPropertyName("code")] string Code,
    int DurationInSecs,
    int DurationInMinutes,
    [property: JsonPropertyName("asset")] string Asset,
    [property: JsonPropertyName("remainingSecs")] int? RemainingSecs = null,
    [property: JsonPropertyName("remainingMins")] int? RemainingMins = null,
    [property: JsonPropertyName("remainingTimer")] string? RemainingTimer = null
)
{
    ...
    public Uri AssetUri => new Uri(Asset);
};
